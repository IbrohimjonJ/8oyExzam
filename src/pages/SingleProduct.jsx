  ...
  return (
    <>
      <main className="mb-10 container grow place-content-center">
        <div className="mx-auto md:w-[700px] lg:w-[1230px] sm:w-[400px] place-content-center">
          <div className="py-10">
            <h2 className="mb-5 text-2xl font-semibold">Recipe elements</h2>
            <div className="flex flex-col ">
              <div className="carousel carousel-center space-x-4 rounded-box bg-neutral p-4 gap-2">
                {data2 &&
              ...
              <div className="place-content-center ml-5">
                ...
                <div className="mb-5">
                  <span className="font-semibold">
                    Prise:
                    <span className="ml-2 font-normal">{data2?.price}</span>
                  </span>
                </div>
